...
if ( ! defined( 'UFHEALTH_UF_HEALTH_EASY_LAST_UPDATED_DIR' ) ) {
	define( 'UFHEALTH_UF_HEALTH_EASY_LAST_UPDATED_DIR', 'lang_dir' );
}
if ( ! defined( 'UFHEALTH_UF_HEALTH_EASY_LAST_UPDATED_PATH' ) ) {
	define( 'UFHEALTH_UF_HEALTH_EASY_LAST_UPDATED_PATH', 'path' );
}
